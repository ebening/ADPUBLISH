 ...
 * @author USUARIO
 */
public class Tabla3 extends javax.swing.JDialog implements ActionListener {
    ...
    public Tabla3(java.awt.Frame parent, boolean modal) {
        ...
        table.getSelectionModel().addListSelectionListener(new Tabla3.RowListener());
        table.getColumnModel().getSelectionModel().addListSelectionListener(new Tabla3.ColumnListener());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                Tabla3 dialog = new Tabla3(new javax.swing.JFrame(), true);
