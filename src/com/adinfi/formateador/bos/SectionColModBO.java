 ...
 * @author ADINFI
 */
public class SectionColModBO {
    private boolean check;
    private int idSectionColMod;
    ...
    public int getIdSectionColMod() {
        return idSectionColMod;
    }

    public void setIdSectionColMod(int idSectionColMod) {
        this.idSectionColMod = idSectionColMod;
    }
