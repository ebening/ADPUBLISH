 ...
 */
public class LanguageModel extends AbstractTableModel {
    ...
    private final String[] columnNames = new String[]{
        ColumNamesConstants.CHECK.getCaption(), ColumNamesConstants.ID.getCaption(), ColumNamesConstants.LANGUAGE.getCaption(), ColumNamesConstants.NOMENCLATURA.getCaption(), ColumNamesConstants.DATEMODIFY.getCaption(), ColumNamesConstants.STATUS.getCaption()
    };
    private final Class[] classes = new Class[]{
        Boolean.class, Integer.class, String.class, String.class, Date.class, Boolean.class
    };
    ...
    public LanguageModel(List<LanguageBO> list) {
        data = new Object[list == null ? 0 : list.size()][];
        for (int i = 0; i < list.size(); i++) {
            LanguageBO row = list.get(i);
            data[i] = new Object[]{
                row.isCheck(),
                row.getIdLanguage(),
                row.getName(),
