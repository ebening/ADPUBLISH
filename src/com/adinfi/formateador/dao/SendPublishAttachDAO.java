...
public class SendPublishAttachDAO {
    ...
    public List<SendPublishAttachBO> get(int idDocumentSendAttach) {
        List<SendPublishAttachBO> list = null;
        exception = null;
        try (Connection conn = ConnectionDB.getInstance().getConnection();) {
            QueryRunner run = new QueryRunner();
            ResultSetHandler<List<SendPublishAttachBO>> h = new BeanListHandler<>(SendPublishAttachBO.class);
            Object[] obj = new Object[]{
                GlobalDefines.SELECT_ACTION,
                idDocumentSendAttach,
                null,
                null,
                null,
                null,
            ...
            list = (List<SendPublishAttachBO>) run.query(conn, SQL_QUERY, h, obj);
        ...
        public List<SendPublishAttachBO> getSaved(int idDocumentSendAttach) {
        List<SendPublishAttachBO> list = null;
        exception = null;
        try (Connection conn = ConnectionDB.getInstance().getConnection();) {
            QueryRunner run = new QueryRunner();
    ...
    public int insertUpdate(SendPublishAttachBO bo) {
        List<SendPublishAttachBO> list = null;
        exception = null;
        ...
        return list == null || list.isEmpty() == true ? -1 : list.get(StatementConstant.SC_0.get()).getIdDocument_send_attach();
    }
    ...
    private static final String SQL_QUERY
            = "{ CALL " + GlobalDefines.DB_SCHEMA + "SPDOCUMENT_SEND_ATTACH (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }";
}
